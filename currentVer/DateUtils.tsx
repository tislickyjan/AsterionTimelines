class DateUtils{
    ...
    static daysInYear: number = 370; 
    static holidaysLabel: string ="Svátky"
    ...
    static getMonthByDay(dayInYear: number){
    ...
    static getMonth(daysFromZero: number) {
    ...
    static getDaysList(month: string){
    ...
    // returns 
    static getDayFromZero(day: string, month: string, year: number){
    ...
    static getDateName(daysFromZero: number){
